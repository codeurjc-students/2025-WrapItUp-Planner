...
![Domain Model](../../images/v.0.2/DomainModel.png)
...
![Server Architecture](../../images/v.0.2/ServerArchitecture.png)

## Client Architecture

The frontend is built using Angular and follows a component-based architecture:

![Client Architecture](../../images/v.0.2/ClientArchitecture.png)
