...
@Tag("unit")
public class OpenAiServiceReflectionUnitTest {
    ...
    @Test
    void parseQuizResponse_questionsNotArray_throws() throws Exception {
        OpenAiService service = new OpenAiService(objectMapper);

        String content = "{\"questions\": \"not-an-array\"}";
        String response = "{\"choices\":[{\"message\":{\"content\":\"" + content.replace("\"", "\\\"") + "\"}}]}";

        assertThrows(java.lang.reflect.InvocationTargetException.class, () ->
            invokePrivate(service, "parseQuizResponse", new Class<?>[]{String.class}, new Object[]{response})
        );
    }

    @Test
    void parseQuizResponse_tooFewQuestions_throws() throws Exception {
        OpenAiService service = new OpenAiService(objectMapper);

        String content = "{\"questions\":[]}"; // 0 questions
        String response = "{\"choices\":[{\"message\":{\"content\":\"" + content.replace("\"", "\\\"") + "\"}}]}";
    ...
    @Test
    void parseQuizResponse_optionCountInvalid_throws() throws Exception {
        OpenAiService service = new OpenAiService(objectMapper);

        String content = "{\"questions\":[{\"question\":\"q\",\"options\":[\"a\",\"b\"],\"correctOptionIndex\":0},{\"question\":\"q2\",\"options\":[\"a\",\"b\"],\"correctOptionIndex\":0},{\"question\":\"q3\",\"options\":[\"a\",\"b\"],\"correctOptionIndex\":0},{\"question\":\"q4\",\"options\":[\"a\",\"b\"],\"correctOptionIndex\":0},{\"question\":\"q5\",\"options\":[\"a\",\"b\"],\"correctOptionIndex\":0}]}";
        String response = "{\"choices\":[{\"message\":{\"content\":\"" + content.replace("\"", "\\\"") + "\"}}]}";
    ...
    @Test
    void parseQuizResponse_emptyOption_throws() throws Exception {
        OpenAiService service = new OpenAiService(objectMapper);

        String content = "{\"questions\":[{\"question\":\"q1\",\"options\":[\"a\",\"\",\"c\",\"d\"],\"correctOptionIndex\":0},{\"question\":\"q2\",\"options\":[\"a\",\"b\",\"c\",\"d\"],\"correctOptionIndex\":1},{\"question\":\"q3\",\"options\":[\"a\",\"b\",\"c\",\"d\"],\"correctOptionIndex\":2},{\"question\":\"q4\",\"options\":[\"a\",\"b\",\"c\",\"d\"],\"correctOptionIndex\":3},{\"question\":\"q5\",\"options\":[\"a\",\"b\",\"c\",\"d\"],\"correctOptionIndex\":0}]}";
        String response = "{\"choices\":[{\"message\":{\"content\":\"" + content.replace("\"", "\\\"") + "\"}}]}";
    ...
    @Test
    void parseQuizResponse_correctOptionIndexInvalid_throws() throws Exception {
        OpenAiService service = new OpenAiService(objectMapper);

        String content = "{\"questions\":[{\"question\":\"q1\",\"options\":[\"a\",\"b\",\"c\",\"d\"],\"correctOptionIndex\":5},{\"question\":\"q2\",\"options\":[\"a\",\"b\",\"c\",\"d\"],\"correctOptionIndex\":1},{\"question\":\"q3\",\"options\":[\"a\",\"b\",\"c\",\"d\"],\"correctOptionIndex\":2},{\"question\":\"q4\",\"options\":[\"a\",\"b\",\"c\",\"d\"],\"correctOptionIndex\":3},{\"question\":\"q5\",\"options\":[\"a\",\"b\",\"c\",\"d\"],\"correctOptionIndex\":0}]}";
        String response = "{\"choices\":[{\"message\":{\"content\":\"" + content.replace("\"", "\\\"") + "\"}}]}";
